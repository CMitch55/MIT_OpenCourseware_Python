...
def get_word_score(word, n):
    ...
    def letter_score(word):
        ...
        for letter in lower_word:
            try:
                let_score += SCRABBLE_LETTER_VALUES[letter]
            except KeyError:
                print("Oops!", letter, "is not a letter!")
            except:
                print("Something has gone horribly wrong.")

        return(int(let_score))

    def len_hand_score(word, n):
        '''
        Returns the second componenet of the word score equation as an int.
        ...
        try:
            ...
            print('Error in calculating second part of word score problem.')

    word_score = 0

    try:
        word_score = int(letter_score(word)) * int(len_hand_score(word, n))
    except:
        print("Error calculating word score.")
    return word_score
